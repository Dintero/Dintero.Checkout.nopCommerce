...
/***/ "./node_modules/@dintero/checkout-web-sdk/dist/dintero-checkout-web-sdk.esm.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@dintero/checkout-web-sdk/dist/dintero-checkout-web-sdk.esm.js ***!
  \*************************************************************************************/
...
/* harmony export */ });
/* harmony import */ var native_promise_only__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! native-promise-only */ "./node_modules/native-promise-only/lib/npo.src.js");
/* harmony import */ var native_promise_only__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(native_promise_only__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _dintero_checkout_web_sdk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @dintero/checkout-web-sdk */ "./node_modules/@dintero/checkout-web-sdk/dist/dintero-checkout-web-sdk.esm.js");


var container = document.getElementById("checkout-container");
var paymentselected = false;
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header").addClass("mb-0");
  displayAjaxLoading(true);
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sandboxDinteroCheckoutWebSDKEndpoint").val() == false) {
    _dintero_checkout_web_sdk__WEBPACK_IMPORTED_MODULE_1__.embed({
      container: container,
      sid: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dinteroOrderSessionResponseId").val(),
      popOut: true,
      language: "no",
      onSession: function onSession(event, checkout) {
        if (event['type'] == 'SessionUpdated') {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
            ...
            type: 'POST',
            data: {
              dinteroSessionId: event.session.id
            }
            ...
            if (result.error >= 0) {
              ...
              jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refreshbtn").show();
              displayAjaxLoading(false);
              checkout.destroy();
            } else {
              if (result.orderSummary) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dinteroOrderSummary").html(result.orderSummary);
              }
              displayAjaxLoading(false);
      ...
      onPayment: function onPayment(event, checkout) {
        checkout.destroy();
        displayAjaxLoading(true);
        // replce test url with local for testing
        window.location.href = event.href;
      },
      onPaymentError: function onPaymentError(event, checkout) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refreshbtn").show();
        checkout.destroy();
      },
      onSessionCancel: function onSessionCancel(event, checkout) {
        window.location.href = "/cart";
      },
      onSessionNotFound: function onSessionNotFound(event, checkout) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refreshbtn").show();
        checkout.destroy();
      },
      onActivePaymentType: function onActivePaymentType(event, checkout) {},
      onValidateSession: function onValidateSession(event, checkout, callback) {
        try {
          displayAjaxLoading(true);
          jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
            cache: false,
    ...
    _dintero_checkout_web_sdk__WEBPACK_IMPORTED_MODULE_1__.embed({
      container: container,
      sid: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#dinteroOrderSessionResponseId").val(),
      endpoint: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sandboxDinteroCheckoutWebSDKEndpoint").val(),
      popOut: true,
      language: "no",
      onSession: function onSession(event, checkout) {
        if (event['type'] == 'SessionUpdated') {
